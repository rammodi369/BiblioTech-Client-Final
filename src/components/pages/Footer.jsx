...
export default function Footer() {
  return (
    <section
      // className="sticky top-[100vh] bg-cover bg-center  text-white py-8 min-h-[25vh] "
      // style={{ backgroundImage: `url(${bgimage})` }}
    >
       <footer className="bg-white border-t py-12">
          <div className="container px-4 mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              { title: "About", links: ["About Us", "Contact", "Feedback"], path: ["/about-us", "/contact", "/feedback"] },
              { title: "Resources", links: ["Study Materials", "Q&A Bank", "Digital Resources"], path: ["/materials", "/qa-bank", "/resources"] },
              { title: "Support", links: ["Help Center", "FAQs", "Privacy Policy"], path: ["/help", "/faq", "/privacy"] },
            ].map((section, i) => (
              <div key={i}>
                ...
                <ul className="space-y-2">
                  {section.links.map((link, j) => (
                    <li key={j}>
                      <Link to={section.path[j]} className="text-gray-600 hover:text-blue-500">
                        {link}
                      </Link>
                    </li>
                  ))}
            ...
            <div>
              ...
              <p className="text-gray-600 mb-4">Subscribe for updates and new resources.</p>
              <input type="email" placeholder="Enter your email" className="border px-3 py-2 w-full rounded-lg mb-2" />
              <button className="w-full bg-blue-600 hover:bg-blue-500 text-white px-6 py-2 rounded-lg">Subscribe</button>
            </div>
          </div>
          <div className="mt-12 pt-8 border-t text-center text-gray-600">
            <p>&copy; Biblio Tech, All rights reserved.</p>
          </div>
        </footer>
          ...
          <div className="w-auto p-8">
            <a href="#">
              <div className="inline-flex items-center">
                ...
                <span className="ml-4 text-lg font-bold">Digi-Library</span>
              </div>
            </a>
          </div>
          <div className="w-auto p-8">
